<nav id="sidebar" aria-label="Main Navigation">
  ...
  <div class="content-header">
    ...
    <a class="fw-semibold text-dual" href="index.html">
      ...
      <span class="smini-hide fs-5 tracking-wider">Manager </span>
    </a>
    <!-- END Logo -->
      ...
      <ul class="nav-main">
        ...
        <li class="nav-main-item">
          <a class="nav-main-link" href="{{ route('tasks-index') }}">
            ...
            <span class="nav-main-link-name">Tâches</span>
          </a>
        </li>
        <li class="nav-main-item">
        ...
        <li class="nav-main-item">
          ...
          <ul class="nav-main-submenu">
            <li class="nav-main-item">
              <a class="nav-main-link" href="{{ route('profils-index') }}">
                <span class="nav-main-link-name">Voir</span>
              </a>
            </li>
            <li class="nav-main-item">
              <a class="nav-main-link" href="{{ route('profils-update') }}">
